...
"[project]/app/sys-admin/requests/accepted/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AcceptedRequestsPage() {
    ...
    const debouncedSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$debounce$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "AcceptedRequestsPage.useCallback[debouncedSearch]": (query)=>{
            if (query !== searchQuery) {
                setIsSearching(true);
                setTimeout({
                    "AcceptedRequestsPage.useCallback[debouncedSearch]": ()=>{
                        setSearchQuery(query);
                        setIsSearching(false);
                    }
                }["AcceptedRequestsPage.useCallback[debouncedSearch]"], 150);
            }
        }
    }["AcceptedRequestsPage.useCallback[debouncedSearch]"], 300), [
        searchQuery
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AcceptedRequestsPage.useEffect": ()=>{
            fetchAllData();
        }
    }["AcceptedRequestsPage.useEffect"], []);
        ...
        "AcceptedRequestsPage.useEffect": ()=>{
            ...
            if (searchQuery.trim()) {
                ...
                filtered = filtered.filter({
                    "AcceptedRequestsPage.useEffect": (request)=>{
                        const searchFields = [
                        ...
                        return searchFields.some({
                            "AcceptedRequestsPage.useEffect": (field)=>field.includes(query)
                        }["AcceptedRequestsPage.useEffect"]);
                    }
                }["AcceptedRequestsPage.useEffect"]);
            }
            ...
            if (serviceTypeFilter !== "all") {
                filtered = filtered.filter({
                    "AcceptedRequestsPage.useEffect": (request)=>request.service_type.toString() === serviceTypeFilter
                }["AcceptedRequestsPage.useEffect"]);
            }
            // Apply date filter
            if (dateFilter) {
    ...
    const handleExport = ()=>{
        try {
            ...
            link.href = url;
            link.setAttribute('download', `accepted_requests_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd')}.csv`);
...
_s(AcceptedRequestsPage, "n2xhGSmusl3vS+sFXvLAo8f8Evo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = AcceptedRequestsPage;
var _c;
__turbopack_context__.k.register(_c, "AcceptedRequestsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e60a9d9d._.js.map
...
"[project]/app/sys-admin/requests/expired/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ExpiredRequestsPage() {
    ...
    const debouncedSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$debounce$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "ExpiredRequestsPage.useCallback[debouncedSearch]": (query)=>{
            if (query !== searchQuery) {
                setIsSearching(true);
                setTimeout({
                    "ExpiredRequestsPage.useCallback[debouncedSearch]": ()=>{
                        setSearchQuery(query);
                        setIsSearching(false);
                    }
                }["ExpiredRequestsPage.useCallback[debouncedSearch]"], 150);
            }
        }
    }["ExpiredRequestsPage.useCallback[debouncedSearch]"], 300), [
        searchQuery
    ]);
        ...
        "ExpiredRequestsPage.useEffect": ()=>{
            ...
            if (searchQuery.trim()) {
                ...
                filtered = filtered.filter({
                    "ExpiredRequestsPage.useEffect": (request)=>{
                        const searchFields = [
                        ...
                        return searchFields.some({
                            "ExpiredRequestsPage.useEffect": (field)=>field.includes(query)
                        }["ExpiredRequestsPage.useEffect"]);
                    }
                }["ExpiredRequestsPage.useEffect"]);
            }
            if (serviceTypeFilter !== "all") {
                filtered = filtered.filter({
                    "ExpiredRequestsPage.useEffect": (request)=>request.service_type.toString() === serviceTypeFilter
                }["ExpiredRequestsPage.useEffect"]);
            }
            if (dateFilter) {
    ...
    const handleExport = ()=>{
        try {
            ...
            link.href = url;
            link.setAttribute('download', `expired_requests_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd')}.csv`);
    ...
    const formatDate = (dateString)=>{
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(dateString), "MMM d, yyyy HH:mm");
        } catch  {
            return dateString;
        }
    };
    const getServiceDisplayName = (row)=>{
        return row.service_type_name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getServiceName"])(row);
    };
    const columns = [
        {
            header: "ID",
...
_s(ExpiredRequestsPage, "pULrBM3mOcV6tl1aRAMqzWZakpQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = ExpiredRequestsPage;
var _c;
__turbopack_context__.k.register(_c, "ExpiredRequestsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_754b62e7._.js.map
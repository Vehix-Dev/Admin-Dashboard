        ...
        },
        {
            ...
            cell: (value: string) => {
                return (
                    <Badge
                        variant="outline"
                        className="capitalize font-medium border-2 border-red-200 bg-red-50 text-red-700"
                    >
            ...
            cell: (value: string, row: RequestRow) => (
                <div className="flex flex-col">
                    ...
                    {row.cancellation_reason && (
                        <span className="text-xs text-gray-500 truncate max-w-[200px]" title={row.cancellation_reason}>
                            {row.cancellation_reason}
                        </span>
                    )}
                </div>
            ...
            <div className="bg-white rounded-lg border shadow-sm min-h-[400px]">
                {isLoading ? (
                    <div className="p-8 flex flex-col items-center justify-center space-y-4">
                        ...
                        <p className="text-gray-600">Loading cancelled requests...</p>
                    </div>
                ) : isSearching ? (
                    <div className="p-8 flex flex-col items-center justify-center space-y-4">

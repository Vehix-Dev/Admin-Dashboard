...
import { Loader2, Filter, Calendar as CalendarIcon, Users, TrendingUp, X } from "lucide-react"
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground font-mono">User Analytics Report</h1>
                    <p className="text-sm text-muted-foreground mt-1 font-mono">User acquisition, distribution, and engagement insights</p>
                </div>
                <Button
